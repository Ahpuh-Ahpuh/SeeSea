...
public class DemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AlarmDialog = new alarm(this); // Move this line into onCreate()
        ...
        WebView webView2 = (WebView) findViewById(R.id.webview2); // assuming you have a WebView with the id "webview2" in your layout
        webView2.setWebViewClient(new WebViewClient()); // sets WebViewClient for this WebView instance

        WebSettings webSettings2 = webView2.getSettings(); // get the settings for this specific WebView instance
        webSettings2.setJavaScriptEnabled(true); // enables JavaScript for this WebView instance

        webView2.loadUrl("http://10.0.2.2:8000/normal1");



//        WebView webView3 = (WebView) findViewById(R.id.webview3); // assuming you have a WebView with the id "webview2" in your layout
//        webView2.setWebViewClient(new WebViewClient()); // sets WebViewClient for this WebView instance
//
//        WebSettings webSettings3 = webView3.getSettings(); // get the settings for this specific WebView instance
//        webSettings3.setJavaScriptEnabled(true); // enables JavaScript for this WebView instance
//
